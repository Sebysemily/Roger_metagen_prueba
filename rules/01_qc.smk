...
rule render_qc_report:
	...
	pre_ybl=expand(f"{QC_DIR}/pre/{{sample}}/Yield_By_Length.html", sample=SAMPLES),
        post_ybl=expand(f"{QC_DIR}/post/{{sample}}/Yield_By_Length.html", sample=SAMPLES),
	
	pre_lvq=expand(f"{QC_DIR}/pre/{{sample}}/LengthvsQualityScatterPlot_kde.html", sample=SAMPLES),
	post_lvq=expand(f"{QC_DIR}/post/{{sample}}/LengthvsQualityScatterPlot_kde.html", sample=SAMPLES) 
